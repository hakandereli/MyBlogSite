...
public class MakaleDao {
    ...
    public void makaleEkle(Makale makale) {
        try {
            ...
            String sql = "INSERT INTO testuniversal.makale (baslik,kayitTarihi,detay,yazar,id_kategori) VALUES (?,?,?,?,?)";
    ...
    public List<Makale> findAllMakale() {
        ...
        try {
            connection = DatabaseConnection.getConnection();
            String sql = "SELECT * FROM testuniversal.makale ORDER BY id ASC;";
    ...
    public List<Makale> findAllMakaleByKategori(Kategori kategori) {
        ...
        try {
            connection = DatabaseConnection.getConnection();
            String sql = "SELECT * FROM testuniversal.makale WHERE id_kategori=? ORDER BY id ASC;";
            ps = connection.prepareStatement(sql);
    ...
    public void deleteMakale(Makale makale) {
        try {
            connection = DatabaseConnection.getConnection();
            String sql = "DELETE FROM testuniversal.makale WHERE id=?";
            ps = connection.prepareStatement(sql);
