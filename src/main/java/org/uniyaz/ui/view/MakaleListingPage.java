...
public class MakaleListingPage extends VerticalLayout {
    ...
    private void makaleGuncelle(Makale makale, Button editButton) {
        ...
        editButton.addClickListener(new Button.ClickListener() {
            @Override
            public void buttonClick(Button.ClickEvent clickEvent) {
                Window makaleUpdateWindow = new Window("Makale Güncelleme");

//                UrunAddUpdatePage urunAddUpdatePage = new UrunAddUpdatePage(urun);
//                urunAddUpdatePage.setMyUpdateWindow(makaleUpdateWindow);
//                urunAddUpdatePage.setMargin(true);
//
//                makaleUpdateWindow.setContent(urunAddUpdatePage);
//                makaleUpdateWindow.center();
//                makaleUpdateWindow.addCloseListener(new Window.CloseListener() {
//                    @Override
//                    public void windowClose(Window.CloseEvent closeEvent) {
//                        fillTable();
//                    }
//                });
//                UI.getCurrent().addWindow(makaleUpdateWindow);
            }
        });
    }
